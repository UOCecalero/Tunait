...
appendBox: function(event){
        ...
        var clonedFecha = document.createElement("div");
            clonedFecha.innerHTML = app.formatTime(event.event_ini,event.event_fin);
...
/*************************************** Entramos en el evento ****************************************************/
    ...
    showEvent: function(eventid){
        ...
        //Hay una opción B que és extraer los datos de los inserts guardados al crear cada evento en el Timeline
            var mode = "g";
            ...
            var body = undefined;
                ...
                app.http(mode, cmd, body, options)
                    ...
                    //Relleno de la página de evento
                                ...
                                document.querySelector("#event-data-date").innerHTML = app.formatTime(eventObj.event_ini, eventObj.event_fin); 
                                ...
                                //document.querySelector("").innerHTML = eventObj. ;
...
/************************************* Set up y settings de el plugin de la cámara ************************************/
    ...
    /*********************************** Funciones para dar formato al dia/hora ***************************************/

    formatTime: function(ini,fin){
